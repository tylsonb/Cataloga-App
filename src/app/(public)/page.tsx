...
import { getActiveCategoriesWithIcon } from "@/modules/shared/repositories/category.repository";
...
export default async function HomePage() {
  ...
  const [categories, { data: featuredProducts }] = await Promise.all([
    getActiveCategoriesWithIcon(),
